...
void LandScape::Draw(Camera *cam) {
    ...
    if (_Light != nullptr) {
        // Model  Lightning
        lightlocation = glGetUniformLocation(currentShader,"lightpos");
        lightcolorlocation = glGetUniformLocation(currentShader,"lightcolor");
    }
    else
        colorlocation = glGetUniformLocation(currentShader,"changecolor");
    ...
    if ( _Light != nullptr) {
        ...
        glm::vec3 color = vec3(0.0,1.0,0.0);
