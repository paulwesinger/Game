...
bool TextRender::Init(int resx, int resy) {
    ...
    //if (FT_New_Face(ft, "/usr/share/fonts/liberation-mono/LiberationMono-Bold.ttf", 0, &face))
...
void TextRender::Render() {
    ...
    projection =  glm::orthoLH(0.0f,static_cast<GLfloat>(_ResX), static_cast<GLfloat>(_ResY), 0.0f,  -100.0f, 100.0f);
